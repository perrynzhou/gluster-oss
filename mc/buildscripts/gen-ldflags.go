...
func genLDFlags(version string) string {
	...
	ldflagsStr = "-s -w -X gluster-oss/mc/cmd.Version=" + version + " "
	ldflagsStr = ldflagsStr + "-X gluster-oss/mc/cmd.ReleaseTag=" + releaseTag(version) + " "
	ldflagsStr = ldflagsStr + "-X gluster-oss/mc/cmd.CommitID=" + commitID() + " "
	ldflagsStr = ldflagsStr + "-X gluster-oss/mc/cmd.ShortCommitID=" + commitID()[:12]
	return ldflagsStr
}
